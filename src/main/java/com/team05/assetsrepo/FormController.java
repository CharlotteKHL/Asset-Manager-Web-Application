...
public class FormController {
	...
	/**
	 * Injecting the JdbcTemplate registered in the Spring appliction context by the
	 * DBConfig class.
	 */
	...
	public void insertAssetData(String title, int lines, String link, String lang, String assoc, String date) {
		...
		try {
			 ...
			 */
			MapSqlParameterSource params = new MapSqlParameterSource().addValue("title", title).addValue("lines", lines)
					.addValue("link", link).addValue("lang", lang).addValue("assoc", assoc).addValue("date", sqlDate);
